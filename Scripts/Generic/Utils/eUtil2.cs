...
namespace edeastudio.Utils
{
    public static partial class Util
    {
        ...
        /// <summary>
        /// Set Vector3 y value equal to zero
        /// </summary>
        /// <param name="vector"></param>
        /// <returns></returns>
        public static Vector3 SetZeroY(this Vector3 vector)
        {
            vector.y = 0;
            return vector;
        }
        /// <summary>
        /// Set Vector3 x value equal to zero
        /// </summary>
        /// <param name="vector"></param>
        /// <returns></returns>
        public static Vector3 SetZeroX(this Vector3 vector)
        {
            vector.x = 0;
            return vector;
        }
        /// <summary>
        /// Set Vector3 z value equal to zero
        /// </summary>
        /// <param name="vector"></param>
        /// <returns></returns>
        public static Vector3 SetZeroZ(this Vector3 vector)
        {
            vector.z = 0;
            return vector;
        }
